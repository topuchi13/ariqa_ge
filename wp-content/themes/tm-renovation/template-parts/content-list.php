	...
	<?php if ( has_post_thumbnail() ) { ?>
		<div class="post-thumb col-md-4">
			<a href="<?php echo esc_url( get_permalink()); ?>">
				<?php the_post_thumbnail( array(850, 500, 'bfi_thumb' => true) ); ?>
			</a>
		</div>
	<?php } ?>
	<div class="<?php echo esc_attr($item_class ? $item_class . ' ' : ''); ?>post-content">
		<?php if ( 'post' == get_post_type() ) : ?>
			<div class="entry-meta">
				...
				<span class="categories-links"><i class="fa fa-folder-open-o"></i> <?php echo get_the_category_list( __( ', ', 'tm-renovation' ) ) ?> </span>
				...
				<?php if (!$infinity_hide_share) : ?>
					<div class="<?php echo esc_attr($class); ?> <?php if (!$infinity_hide_tags) { echo 'end-sm'; }?>">
						<div class="post-share-buttons">
							<span><?php echo __( 'Share ', 'tm-renovation' ); ?></span>
