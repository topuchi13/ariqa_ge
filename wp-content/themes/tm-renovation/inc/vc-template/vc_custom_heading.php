...
if ( ! empty( $font_container_data ) && isset( $font_container_data['values'] ) && isset( $font_container_data['values']['text_align'] ) ) {
	$css_class .= ' align-' . $font_container_data['values']['text_align'];
}
