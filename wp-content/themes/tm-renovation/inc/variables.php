...
define( 'SITE_LOGO', 'https://renovation.thememove.com/data/images/logo.png' );
define( 'SITE_LOGO_PADDING_TOP', '47px' );
define( 'SITE_LOGO_PADDING_BOTTOM', '47px' );
define( 'SITE_LOGO_PADDING_LEFT', '15px' );
define( 'SITE_LOGO_PADDING_RIGHT', '20px' );

define( 'SITE_FAVICON', 'https://renovation.thememove.com/data/images/favicon.ico' );
define( 'SITE_APPLE_TOUCH_ICON', 'https://renovation.thememove.com/data/images/apple_touch_icon.png' );
...
define( 'SITE_STYLE_BODY_FONT_VARIANT', 'regular' );
define( 'SITE_STYLE_BODY_FONT_SIZE', '15px' );
define( 'SITE_STYLE_BODY_LINE_HEIGHT', '1.5' );
define( 'SITE_STYLE_BODY_LETTER_SPACING', '0em' );
define( 'SITE_STYLE_BODY_TEXT', '#777' );

define( 'SITE_STYLE_HEADING_FONT_FAMILY', 'Montserrat' );
define( 'SITE_STYLE_HEADING_FONT_VARIANT', '700' );
define( 'SITE_STYLE_HEADING_LINE_HEIGHT', '1.2' );
define( 'SITE_STYLE_HEADING_LETTER_SPACING', '0em' );
...
define( 'SITE_STYLE_HEADING_H5_FONT_SIZE', 14 );
define( 'SITE_STYLE_HEADING_H6_FONT_SIZE', 12 );
...
define( 'TOP_STYLE_LINK_FONT_SIZE', '14px' );
define( 'TOP_STYLE_LINK_FONT_COLOR', 'rgba(255,255,255,.6)' );
define( 'TOP_STYLE_LINK_FONT_COLOR_HOVER', 'rgba(255,255,255,1)' );
define( 'TOP_PADDING_TOP', '0px' );
define( 'TOP_PADDING_BOTTOM', '0px' );
define( 'TOP_PADDING_LEFT', '0px' );
define( 'TOP_PADDING_RIGHT', '0px' );
define( 'TOP_MARGIN_TOP', '0px' );
define( 'TOP_MARGIN_BOTTOM', '0px' );
define( 'TOP_MARGIN_LEFT', '0px' );
define( 'TOP_MARGIN_RIGHT', '0px' );
define( 'TOP_BORDER_WIDTH', '0px' );
...
define( 'HEADER_SPACING_PADDING_TOP', '0px' );
define( 'HEADER_SPACING_PADDING_BOTTOM', '0px' );
define( 'HEADER_SPACING_PADDING_LEFT', '0px' );
define( 'HEADER_SPACING_PADDING_RIGHT', '0px' );
define( 'HEADER_SPACING_MARGIN_TOP', '0px' );
define( 'HEADER_SPACING_MARGIN_BOTTOM', '0px' );
define( 'HEADER_SPACING_MARGIN_LEFT', '0px' );
define( 'HEADER_SPACING_MARGIN_RIGHT', '0px' );

define( 'HEADER_BORDER_WIDTH', '0px' );
 ...
 * Social
 */
define( 'SOCIAL_LINKS_ENABLE', 1 );
define( 'SOCIAL_LINKS_COLOR', SECONDARY_COLOR );
define( 'SOCIAL_LINKS_COLOR_HOVER', PRIMARY_COLOR );
define( 'SOCIAL_LINKS_BG_COLOR', PRIMARY_COLOR );
define( 'SOCIAL_LINKS_BG_COLOR_HOVER', SECONDARY_COLOR );
define( 'FOOTER_SOCIAL_LINKS_COLOR', SECONDARY_COLOR );
define( 'FOOTER_SOCIAL_LINKS_COLOR_HOVER', PRIMARY_COLOR );
define( 'FOOTER_SOCIAL_LINKS_BG_COLOR', PRIMARY_COLOR );
define( 'FOOTER_SOCIAL_LINKS_BG_COLOR_HOVER', SECONDARY_COLOR );
define( 'MOBILE_MENU_SOCIAL_LINKS_COLOR', SECONDARY_COLOR );
define( 'MOBILE_MENU_SOCIAL_LINKS_COLOR_HOVER', PRIMARY_COLOR );
...
define( 'NAV_TYPO_MENU_FONT_VARIANT', '700' );
define( 'NAV_TYPO_MENU_FONT_SIZE', '14px' );
define( 'NAV_TYPO_MENU_LINE_HEIGHT', '1.2' );
define( 'NAV_TYPO_MENU_LETTER_SPACING', '0em' );
...
define( 'NAV_TYPO_SUB_MENU_FONT_SIZE', '14px' );
define( 'NAV_TYPO_SUB_MENU_FONT_VARIANT', 'regular' );
define( 'NAV_TYPO_SUB_MENU_LINE_HEIGHT', '1' );
define( 'NAV_TYPO_SUB_MENU_LETTER_SPACING', '0em' );
define( 'NAV_STYLE_SUB_MENU_TEXT', '#666' );
define( 'NAV_STYLE_SUB_MENU_TEXT_HOVER', SECONDARY_COLOR );

define( 'NAV_SPACING_MENU_TEXT_PADDING_TOP', '27px' );
define( 'NAV_SPACING_MENU_TEXT_PADDING_BOTTOM', '23px' );
define( 'NAV_SPACING_MENU_TEXT_PADDING_LEFT', '20px' );
define( 'NAV_SPACING_MENU_TEXT_PADDING_RIGHT', '20px' );
define( 'NAV_SPACING_SUB_MENU_TEXT_PADDING_TOP', '15px' );
define( 'NAV_SPACING_SUB_MENU_TEXT_PADDING_BOTTOM', '17px' );
define( 'NAV_SPACING_SUB_MENU_TEXT_PADDING_LEFT', '20px' );
define( 'NAV_SPACING_SUB_MENU_TEXT_PADDING_RIGHT', '20px' );
...
define( 'BUTTON_STYLE_FONT_SIZE', '13px' );
define( 'BUTTON_STYLE_FONT_VARIANT', '700' );
define( 'BUTTON_STYLE_FONT_LINE_HEIGHT', '1.2' );
define( 'BUTTON_STYLE_FONT_LETTER_SPACING', '0em' );
define( 'BUTTON_STYLE_LINK_COLOR', SECONDARY_COLOR );
define( 'BUTTON_STYLE_LINK_COLOR_HOVER', '#fff' );

define( 'BUTTON_PADDING_TOP', '10px' );
define( 'BUTTON_PADDING_BOTTOM', '10px' );
define( 'BUTTON_PADDING_LEFT', '15px' );
define( 'BUTTON_PADDING_RIGHT', '15px' );
define( 'BUTTON_MARGIN_TOP', '0px' );
define( 'BUTTON_MARGIN_BOTTOM', '0px' );
define( 'BUTTON_MARGIN_LEFT', '0px' );
define( 'BUTTON_MARGIN_RIGHT', '0px' );

define( 'BUTTON_BORDER_WIDTH', '2px' );
...
define( 'FOOTER_STYLE_FONT_SIZE', '14px' );
define( 'FOOTER_STYLE_FONT_VARIANT', 'regular' );
...
define( 'FOOTER_GENERAL_PADDING_TOP', '70px' );
define( 'FOOTER_GENERAL_PADDING_BOTTOM', '70px' );
define( 'FOOTER_GENERAL_PADDING_LEFT', '0px' );
define( 'FOOTER_GENERAL_PADDING_RIGHT', '0px' );
define( 'FOOTER_GENERAL_MARGIN_TOP', '0px' );
define( 'FOOTER_GENERAL_MARGIN_BOTTOM', '0px' );
define( 'FOOTER_GENERAL_MARGIN_LEFT', '0px' );
define( 'FOOTER_GENERAL_MARGIN_RIGHT', '0px' );

define( 'FOOTER_BORDER_WIDTH', '0px' );
define( 'FOOTER_BORDER_STYLE', 'solid' );
define( 'FOOTER_BORDER_COLOR', '#000' );

define( 'FOOTER_BG_IMAGE', 'https://renovation.thememove.com/data/images/footer-bg.jpg' );
...
define( 'COPYRIGHT_GENERAL_PADDING_TOP', '50px' );
define( 'COPYRIGHT_GENERAL_PADDING_BOTTOM', '40px' );
define( 'COPYRIGHT_GENERAL_PADDING_LEFT', '0px' );
define( 'COPYRIGHT_GENERAL_PADDING_RIGHT', '0px' );
define( 'COPYRIGHT_GENERAL_MARGIN_TOP', '0px' );
define( 'COPYRIGHT_GENERAL_MARGIN_BOTTOM', '0px' );
define( 'COPYRIGHT_GENERAL_MARGIN_LEFT', '0px' );
define( 'COPYRIGHT_GENERAL_MARGIN_RIGHT', '0px' );
...
define( 'PAGE_STYLE_HEADING_FONT_SIZE', '36px' );
define( 'PAGE_STYLE_HEADING_FONT_VARIANT', '700' );
define( 'PAGE_STYLE_HEADING_LETTER_SPACING', '-0.025em' );
define( 'PAGE_STYLE_HEADING_FONT_COLOR', '#fff' );

define( 'PAGE_SPACING_PADDING_TOP', '80px' );
define( 'PAGE_SPACING_PADDING_BOTTOM', '80px' );
define( 'PAGE_SPACING_PADDING_LEFT', '0px' );
define( 'PAGE_SPACING_PADDING_RIGHT', '0px' );

define( 'PAGE_HEADING_BG_COLOR', SECONDARY_COLOR );
define( 'PAGE_OVERLAY_BG_COLOR', 'rgba(17,17,17,0.7)' );
define( 'PAGE_HEADING_BG_IMAGE', 'https://renovation.thememove.com/data/images/page_heading_bg01.jpg' );
...
define( 'POST_STYLE_HEADING_TEXT', esc_html__( 'Blog', 'tm-renovation' ) );
...
define( 'POST_STYLE_HEADING_FONT_SIZE', '36px' );
define( 'POST_STYLE_HEADING_FONT_VARIANT', '700' );
define( 'POST_STYLE_HEADING_LETTER_SPACING', 0 );
define( 'POST_STYLE_HEADING_FONT_COLOR', '#fff' );

define( 'POST_SPACING_PADDING_TOP', '80px' );
define( 'POST_SPACING_PADDING_BOTTOM', '80px' );
define( 'POST_SPACING_PADDING_LEFT', '0px' );
define( 'POST_SPACING_PADDING_RIGHT', '0px' );

define( 'POST_HEADING_BG_COLOR', SECONDARY_COLOR );
define( 'POST_OVERLAY_BG_COLOR', 'rgba(29,39,54,0.9)' );
define( 'POST_HEADING_BG_IMAGE', 'https://renovation.thememove.com/data/images/page_heading_bg01.jpg' );
