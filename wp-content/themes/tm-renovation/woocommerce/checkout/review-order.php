...
<table class="shop_table woocommerce-checkout-review-order-table">
	<thead>
		<tr>
			<th class="product-name"><?php esc_html_e( 'Product', 'tm-renovation' ); ?></th>
			<th class="product-total"><?php esc_html_e( 'Total', 'tm-renovation' ); ?></th>
		</tr>
	</thead>
	<tbody>
		<?php
	...
	<tfoot>
		...
		<tr class="cart-subtotal">
			<td><?php esc_html_e( 'Subtotal', 'tm-renovation' ); ?></td>
    ...
    <?php foreach ( $available_methods as $method ) : ?>
      <?php if ( $chosen_shipping != '' && strpos( $method->id, $chosen_shipping ) === 0 ) { ?>
        <tr class="shipping">
          <td><?php esc_html_e( 'Shipping and Handling', 'tm-renovation' ); ?></td>
    ...
    <?php endforeach; ?>
		...
		<tr class="order-total">
			<td><?php esc_html_e( 'Total', 'tm-renovation' ); ?></td>
